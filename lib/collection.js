...
Collection.prototype.get = function (id, options)
{
    ...
    if (!record)
    {
        record = new cls(this.service, { id: id }, this.methods)
        cache[id] = record
    }
...
Collection.prototype.create = function (fields)
{
    ...
    if (!record)
    {
        record = new records.SyncRecord(this.service, fields, this.methods)
        if (watch.watcher)
        {
            watch.watcher.push(record)
        }
...
Collection.prototype.find = function (options)
{
    ...
    if (!list)
    {
        list = new cls(this.service, options, this.methods)
    }
